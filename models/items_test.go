...
var (
	itemDBTypes = map[string]string{`ID`: `bigint`, `Title`: `text`, `URL`: `text`, `Thumbnail`: `text`, `Sort`: `uuid`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
